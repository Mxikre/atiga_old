                ...
                <div class="row mt-5 pt-4">
                    <div class="dash-item col-md-4 d-flex justify-content-end">
                        <div class="card" id="card1">
                            <a href="pengiriman.php" class="card-link">
                                <span class="d-flex"><i data-feather="truck"></i>
                                    <h1 class="ms-2"><?php echo $jumlahDeliveries ?></h1>
                                </span>
                                <span class="card-text">Pengiriman</span>
                            </a>
                        </div>
                    </div>
